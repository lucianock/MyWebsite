    ...
    <div className="hero-banner" id="home">
      <div className="container">
        <div className="content-inner">
          <h2 className="hero-subtitle">{t('common.hello')}</h2>
          <h1 className="hero-title">
            {t('common.iAm')} <span className="bottom-border">Luciano</span>
          </h1>
          ...
          <ul className="buttons">
            <li>
              <Button arrow text={t('hero.downloadCV')} onClick={downloadPdf} />
            </li>
            <li>
              <a
                href={whatsappUrl}
